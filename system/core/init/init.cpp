    ...
    if (!strcmp(name,"qemu")) {
        ...
        if (cnt < PROP_NAME_MAX){
            if(access("/.cell", F_OK)==0 && 
                (strcmp(boot_prop_name,"serialno")==0 ||
                  strcmp(boot_prop_name,"bootloader")==0 ||
                  strcmp(boot_prop_name,"hardware")==0 ||
                  strcmp(boot_prop_name,"radio")==0
                  )){
            }else{
...
static void export_kernel_boot_props() {
    ...
    for (size_t i = 0; i < ARRAY_SIZE(prop_map); i++) {
        if(access("/.cell", F_OK)==0 && 
            (strcmp(prop_map[i].src_prop,"ro.boot.serialno")==0||
             strcmp(prop_map[i].src_prop,"ro.boot.bootloader")==0||
             strcmp(prop_map[i].src_prop,"ro.boot.hardware")==0)){
            continue;
        }
