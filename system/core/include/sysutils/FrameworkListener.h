...
class SocketClient;
#define CMD_HOOK_PROCESSED	1
#define CMD_HOOK_RUN		2
typedef int (*CmdHookFunc)(SocketClient *c, int *argc, char **argv);
...
protected:
    ...
    void registerCmdHook(CmdHookFunc func);
