        ...
        new Creator<WifiInfo>() {
            public WifiInfo createFromParcel(Parcel in) {
                    ...
                    try {
                        ...
                        /*if(SystemProperties.get("ro.boot.vm").equals("1")){
                            if(Process.myUid() >= Process.FIRST_APPLICATION_UID){
                                String paddr = SystemProperties.get("ro.cell.wf.ipaddr","-2078496576");
                                byte[] b = paddr.getBytes();
                                info.setInetAddress(InetAddress.getByAddress(b));
                            }
                        }*/
                ...
                if (in.readInt() == 1) {
                    ...
                    /*if(SystemProperties.get("ro.boot.vm").equals("1")){
                        if(Process.myUid() >= Process.FIRST_APPLICATION_UID){
                            WifiSsid ssid = WifiSsid.createFromHex(SystemProperties.get("ro.cell.wf.ssid","Xiaomi_4B9D"));
                            info.mWifiSsid = ssid;
                        }
                    }*/
                }
