...
import android.app.CellsServiceManager;
...
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.CELLS_SERVICE, CellsServiceManager.class,
                new CachedServiceFetcher<CellsServiceManager>() {
            @Override
            public CellsServiceManager createService(ContextImpl ctx) {
                IBinder b = ServiceManager.getService(Context.CELLS_SERVICE);
                ICellsService service = ICellsService.Stub.asInterface(b);
                return new CellsServiceManager(ctx, service);
            }});
