...
int IPCThreadState::getCallingSystemMode() const
{
    return mCallingSystemMode;
}
      ...
      mLastTransactionBinderFlags(0)
{
	...
	if (strcmp(value, "1") == 0) {
		mCallingSystemMode = 1;
	}else{
        mCallingSystemMode = 0;
    }
    ...
    case BR_TRANSACTION:
        {
            ...
            const int   origSystemMode = mCallingSystemMode;
            const int32_t origStrictModePolicy = mStrictModePolicy;
            const int32_t origTransactionBinderFlags = mLastTransactionBinderFlags;

            mCallingPid = tr.sender_pid;
            mCallingUid = tr.sender_euid;
            mCallingSystemMode = tr.sender_systemmode;
            ...
            mCallingPid = origPid;
            mCallingUid = origUid;
            mCallingSystemMode = origSystemMode;
