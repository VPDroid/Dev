...
static char cellvendor[PROPERTY_VALUE_MAX] = {0};
static char cellversion[PROPERTY_VALUE_MAX] = {0};
static char cellextensions[PROPERTY_VALUE_MAX] = {0};
static char cellclientapis[PROPERTY_VALUE_MAX] = {0};

static const char* eglQueryString_VM(EGLDisplay dpy, EGLint name)
{
    switch (name) {
        case EGL_VENDOR:
            property_get("ro.cell.egl.vendor", cellvendor, "");
            return cellvendor;
        case EGL_VERSION:
            property_get("ro.cell.egl.version", cellversion, "");
            return cellversion;
        case EGL_EXTENSIONS:
            property_get("ro.cell.egl.extensions", cellextensions, "");
            return cellextensions;
        case EGL_CLIENT_APIS:
            property_get("ro.cell.egl.clientapis", cellclientapis, "");
            return cellclientapis;
    }
...
const char* eglQueryString(EGLDisplay dpy, EGLint name)
{
    ...
    if((strcmp(value, "1") == 0)){
        return eglQueryString_VM(dpy, name);
    }*/
