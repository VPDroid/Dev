...
public:
    ...
    virtual status_t goToSleep(long eventTime, int reason, int flags) = 0;
    virtual status_t wakeUp(long eventTime, const String16& reason, const String16& opPackageName) = 0;
};
